    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(180deg, transparent 0%, rgba(37,99,235,0.3) 40%, rgba(37,99,235,0.1) 70%, transparent 100%)' }}
        />
        ...
        {/* Main content */}
        <div className="relative animate-slide-up" style={{ animationDelay: '80ms', opacity: 0, animationFillMode: 'forwards' }}>
          {/* Badge */}
          <div
          ...
          >
            <div className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ backgroundColor: '#60A5FA' }} />
          ...
          <h1 className="text-4xl xl:text-[2.75rem] font-800 text-white leading-[1.08] tracking-tight mb-5">
            Field service<br />
            <span className="text-gradient-blue">{BRAND_IDENTITY.tagline.split(' ').slice(0, 2).join(' ')},</span><br />
            simplified.
          </h1>
          <p className="text-[15px] leading-relaxed mb-10" style={{ color: 'rgba(148,163,184,0.85)' }}>
            ...
            {features.map((f, i) => {
              ...
              return (
                <div
                  ...
                  style={{ animationDelay: `${160 + i * 60}ms`, opacity: 0, animationFillMode: 'forwards' }}
                >
                  <div
                    className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: 'rgba(37,99,235,0.2)', border: '1px solid rgba(37,99,235,0.25)' }}
                  >
                    <FIcon size={15} style={{ color: '#60A5FA' }} />
                  </div>
                  <p className="text-[13.5px] font-500" style={{ color: 'rgba(203,213,225,0.85)' }}>{f.text}</p>
                </div>
              );
            })}
          </div>
        ...
        >
          {stats.map((s, i) => (
            ...
            >
              ...
              <p className="text-[11px] font-500" style={{ color: 'rgba(148,163,184,0.6)' }}>{s.label}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      >
        ...
        <div className="w-full max-w-[400px] relative animate-slide-up" style={{ opacity: 0, animationFillMode: 'forwards' }}>
          {/* Tab switcher */}
          <div
        ...
        {/* Bottom trust note */}
        <p className="relative mt-8 text-[11px] text-center" style={{ color: 'var(--muted-foreground)' }}>
