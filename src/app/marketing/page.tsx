...
const FEATURES = [
  ...
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 18h.01M8 21h8a2 2 0 002-2v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2a2 2 0 002 2zM12 3a4 4 0 100 8 4 4 0 000-8z" />
      </svg>
    ),
...
const INDUSTRIES = [
  'Commercial Cleaning', 'Residential Cleaning', 'Property Maintenance',
  'Electrical Contractors', 'Plumbers', 'Landscapers',
  'Pest Control', 'Security Services', 'HVAC',
  'Mobile Service Businesses', 'Trade Contractors', 'Inspection Services',
];
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0F1C2E]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#2563EB]/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#1d4ed8]/15 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '6s', animationDelay: '2s' }} />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-20">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="text-white/80 text-xs font-medium tracking-wide">Intelligent Micro Business Operations Management</span>
          </div>
          ...
          <p className="text-lg lg:text-xl text-slate-300 leading-relaxed max-w-2xl mb-10">
            Innovion gives growing micro businesses complete operational control by bringing customers, jobs, staff, contractors, scheduling, compliance, inventory and reporting together in one intelligent cloud platform.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <div className="inline-flex items-center gap-2 bg-red-50 border border-red-100 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-red-600 text-xs font-semibold tracking-wide uppercase">The Problem</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold text-[#0F1C2E] leading-tight mb-6">
              Most micro businesses run on chaos
            </h2>
            <p className="text-lg text-slate-500 leading-relaxed mb-8">
              As businesses grow, disconnected systems become impossible to manage — resulting in lost information, inconsistent processes and reduced productivity.
            </p>
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              <p className="text-sm font-semibold text-slate-400 uppercase tracking-wide mb-4">Sound familiar?</p>
            ...
            <div className="relative">
              ...
              <div className="relative p-8">
                <div className="space-y-4">
                  {[
                    { title: 'Lost Information', desc: 'Job details scattered across texts, emails and sticky notes', pct: 78 },
                    { title: 'Inconsistent Processes', desc: 'Every staff member does things differently', pct: 65 },
                    { title: 'Reduced Productivity', desc: 'Hours wasted on admin instead of billable work', pct: 54 },
                  ].map((item) => (
                    <div key={item.title} className="bg-white rounded-2xl p-5 shadow-sm border border-red-100">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-[#2563EB] text-xs font-semibold tracking-wide uppercase">The Solution</span>
          </div>
          <h2 className="text-4xl lg:text-5xl font-bold text-[#0F1C2E] leading-tight mb-6">
            Everything centralised.<br />Everything connected.
          </h2>
          <p className="text-lg text-slate-500 leading-relaxed">
            Innovion centralises your entire operation into one intelligent platform. Manage your business from anywhere. Know exactly what is happening. Stay organised. Scale with confidence.
          </p>
        </div>

        <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {[
            {
              icon: (
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-white border border-slate-200 rounded-full px-4 py-1.5 mb-6">
            <div className="w-1.5 h-1.5 bg-[#2563EB] rounded-full" />
            <span className="text-slate-600 text-xs font-semibold tracking-wide uppercase">Platform Features</span>
          </div>
          <h2 className="text-4xl lg:text-5xl font-bold text-[#0F1C2E] leading-tight mb-4">
            Everything your business needs
          </h2>
          <p className="text-lg text-slate-500">
            Ten powerful modules. One unified platform.
          </p>
        </div>

        {/* Bento grid */}
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <div className="inline-flex items-center gap-2 bg-slate-100 border border-slate-200 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-slate-600 text-xs font-semibold tracking-wide uppercase">Industries</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold text-[#0F1C2E] leading-tight mb-6">
              Built for operational businesses
            </h2>
            <p className="text-lg text-slate-500 leading-relaxed mb-8">
              Innovion was developed from real operational experience. Every workflow has been designed around the way micro businesses actually operate — not how software companies think they should operate.
            </p>
            <Link
            ...
            <div className="grid grid-cols-2 gap-3">
              {INDUSTRIES.map((industry, i) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-slate-600 group-hover:text-[#1E3A5F]">{industry}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-white/70 text-xs font-semibold tracking-wide uppercase">Why Innovion</span>
            </div>
            ...
            <p className="text-slate-400 leading-relaxed">
              Simple enough for every employee. Powerful enough to transform the way your business works.
            </p>
          </div>
          ...
          <div className={`transition-all duration-700 delay-200 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="space-y-4">
              {[
                { title: 'Manage from anywhere', desc: 'Cloud-based platform accessible from any device, anywhere in the world.' },
                { title: 'Real-time visibility', desc: 'Know exactly what is happening across your entire operation at any moment.' },
                { title: 'Scales with you', desc: 'Add staff, customers and jobs without adding complexity or cost.' },
                { title: 'Built for the field', desc: 'Mobile-first design that works for office staff and field workers alike.' },
              ].map((item, i) => (
                <div
                  key={item.title}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-white border border-slate-200 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-slate-600 text-xs font-semibold tracking-wide uppercase">Coralamy Group</span>
          </div>
          <h2 className="text-4xl lg:text-5xl font-bold text-[#0F1C2E] leading-tight mb-4">
            Part of something bigger
          </h2>
          <p className="text-lg text-slate-500 leading-relaxed">
            Innovion is one of the intelligent business platforms developed by the Coralamy Group. As your organisation grows, additional solutions can extend your capability.
          </p>
        </div>
        ...
        <p className="text-center text-sm text-slate-400 mt-8">
          Each platform has a distinct purpose while working together as part of the Coralamy business ecosystem.
        </p>
      </div>
    </section>
  );
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-slate-100 border border-slate-200 rounded-full px-4 py-1.5 mb-6">
            <div className="w-1.5 h-1.5 bg-[#2563EB] rounded-full" />
            <span className="text-slate-600 text-xs font-semibold tracking-wide uppercase">Customer Stories</span>
          </div>
          <h2 className="text-4xl lg:text-5xl font-bold text-[#0F1C2E] leading-tight mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-slate-50 rounded-2xl border border-slate-100 p-8 flex flex-col gap-4">
              ...
              <p className="text-slate-400 text-sm italic leading-relaxed">
                &ldquo;Customer testimonial reserved for future use. Start your free trial and be among our first success stories.&rdquo;
              </p>
  ...
  return (
    <section className="py-24 bg-[#1E3A5F] relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <p className="text-slate-400 text-sm mt-6">No credit card required. Free 14-day trial. Cancel anytime.</p>
      </div>
    </section>
  );
}
