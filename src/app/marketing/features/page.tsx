    ...
    items: [
      {
        ...
        points: ['Complete customer profiles', 'Multiple site locations', 'Contact management', 'Operational notes & history'],
      },
      {
        icon: (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        points: ['One-off and recurring jobs', 'Resource allocation', 'Real-time progress tracking', 'Job history and reporting'],
      },
      {
        icon: (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        points: ['Drag-and-drop interface', 'Recurring job scheduling', 'Team workload visibility', 'Conflict detection'],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        points: ['Employee profiles', 'Contractor management', 'Role and qualification tracking', 'Operational responsibilities'],
      },
      {
        icon: (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        points: ['Location-aware clock on/off', 'Attendance verification', 'Site arrival confirmation', 'Time tracking'],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        points: ['Document storage', 'Expiry reminders', 'Induction tracking', 'Insurance management'],
      },
      {
        icon: (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        points: ['Multi-location stock tracking', 'Supply request management', 'Approved product lists', 'Low stock alerts'],
      },
      {
        icon: (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        points: ['Secure document storage', 'Policy management', 'Safety documentation', 'Customer documents'],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        points: ['Real-time dashboards', 'Operational reports', 'Performance metrics', 'Custom reporting'],
      },
    ],
  },
];
  ...
  return (
    <div className="pt-16">
      ...
      <section className="bg-[#0F1C2E] py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-white/70 text-xs font-semibold tracking-wide uppercase">Platform Features</span>
          </div>
          <h1 className="text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            Everything your business needs.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#60a5fa] to-[#93c5fd]">Nothing it doesn&apos;t.</span>
          </h1>
      ...
      {ALL_FEATURES?.map((category, ci) => (
        <section key={category?.category} className={`py-20 ${ci % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="mb-12">
              <span className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5">
                ...
                <span className="text-[#2563EB] text-xs font-semibold tracking-wide uppercase">{category?.category}</span>
              </span>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {category?.items?.map((feature) => (
                <div key={feature?.title} className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
