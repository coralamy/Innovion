...
const statusConfig: Record<
  string,
  { bg: string; text: string; label: string; icon: React.ElementType; dot: string }
> = {
  compliant: {
    bg: 'var(--success-bg)',
    text: 'var(--success)',
      ...
      try {
        ...
        if (data.length > 0 && user?.email) {
          ...
          if (alertItems.length > 0) {
            const emailItems = alertItems.map((i) => ({
              title: i.title,
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Track licenses, certifications, insurance, and WHS requirements
            </p>
          </div>
          {canManage && (
            <button
        ...
        {error && (
          <div className="alert-error" role="alert">
            ...
            <button
              ...
              className="text-xs font-600 underline underline-offset-2 flex-shrink-0"
            >
              Retry
            </button>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-danger/80 mt-0.5">
                ...
                {stats.expiring > 0 &&
                  `${stats.expiring} item${stats.expiring > 1 ? 's' : ''} expiring within 30 days`}
              </p>
            </div>
          </div>
        )}
                    ...
                    return (
                      ...
                      >
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">{item.documentRef}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3">
                          ...
                          {item.daysUntilExpiry < 30 && item.daysUntilExpiry >= 0 && (
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1">
                            <PlannedAction
                              ...
                              title="Downloading a compliance certificate is not available yet — no document is attached to a compliance item."
                            >
            ...
            <div className="empty-state">
              ...
              <p className="empty-state-desc">
                {search || filterStatus !== 'all' || filterCategory !== 'all'
                  ...
                  : 'Add your first compliance item to start tracking licenses, certifications, and insurance'}
              </p>
